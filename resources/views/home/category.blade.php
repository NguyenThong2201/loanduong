		...
		<section class="container">
						...
						<div class="section-filter-item opened">
							...
							<div class="section-filter-fields">
								<ul class="section-filter-color">
									<li class="active"><img src="/home/img/color/red.jpg" alt="Red"></li>
									<li><img src="/home/img/color/blue.jpg" alt="Blue"></li>
									<li><img src="/home/img/color/green.jpg" alt="Green"></li>
									<li><img src="/home/img/color/yellow.jpg" alt="Yellow"></li>
									<li><img src="/home/img/color/purple.jpg" alt="Purple"></li>
								</ul>
							</div>
						</div>
						<div class="section-filter-item opened">
			...
			<div class="section-cont">
				...
				<div class="prod-items section-items">
					@foreach($productByCategory as $items)
						<div class="prod-i">
						<div class="prod-i-top">
							<a href="{{ route('detail', $items->title_sale) }}" class="prod-i-img">
								<!-- NO SPACE -->
								<img src="/page/image/product/{{$items->image}}" alt="Adipisci aperiam commodi">
								<!-- NO SPACE -->
							</a>
							<p class="prod-i-info">
