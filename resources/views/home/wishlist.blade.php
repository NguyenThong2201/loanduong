                ...
                <div class="prod-items section-items">
                    @foreach($wishList as $items)
                        ...
                        <div class="prod-i-top">
                            <a href="{{ route('detail', $items->products->title_sale) }}" class="prod-i-img">
                                <!-- NO SPACE -->
                                <img src="/page/image/product/{{$items->products->image}}" alt="Sunt temporibus velit">
                                <!-- NO SPACE -->
                            </a>
                            <p class="prod-i-info">
                                <a href="javascript:void(0)" class="prod-i-favorites"><span>Remove from Wishlist</span><i class="fa fa-remove"></i></a>
                                <a href="javascript:void(0)" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                                <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
                            </p>
                            <a href="javascript:void(0)" class="prod-i-buy">Add to cart</a>
                        ...
                        <h3>
                            <a href="{{ route('detail', $items->products->title_sale) }}">{{ $items->products->title }}</a>
                        </h3>
                        <p class="prod-i-price">
                            <b>{{ number_format($items->products->unit_price)}}đ</b>
                        </p>
                    </div>
                    @endforeach
                </div>
