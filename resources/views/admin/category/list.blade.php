            ...
            <div class="block-content collapse in">
                <div class="span12">
                   <div class="table-toolbar">
                      <div class="btn-group">
                         <a href="{{route('addCategory')}}"><button class="btn btn-success">Thêm Loại <i class="icon-plus icon-white"></i></button></a>
                      </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                        ...
                        <tbody>
                            @foreach($listCategory as $items)
                                <tr class="odd gradeX">
                                    <td width="80px">{{$items->category_id}}</td>
                                    <td width="140px">{{$items->title}}</td>
